...
#ifndef __expo_clover_term_w_h__
#define __expo_clover_term_w_h__
...
#include "expo_clover_term_qdp_w.h"
namespace Chroma {
  using ExpoCloverTerm  = QDPExpoCloverTerm;
  using ExpoCloverTermF = QDPExpoCloverTermF;
  using ExpoCloverTermD = QDPExpoCloverTermD;

  template<typename T,typename U>
  using ExpoCloverTermT = QDPExpoCloverTermT<T,U>;
}  // end namespace Chroma
