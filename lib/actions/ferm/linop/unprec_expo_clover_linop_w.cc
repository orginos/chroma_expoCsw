...
{ 
   ...
   */
  void UnprecExpoCloverLinOp::create(Handle< FermState<T,P,Q> > fs,
   ...
   */
  void UnprecExpoCloverLinOp::operator()(LatticeFermion & chi, 
  ...
  void 
  UnprecExpoCloverLinOp::deriv(multi1d<LatticeColorMatrix>& ds_u,
  ...
  unsigned long UnprecExpoCloverLinOp::nFlops() const
  {
